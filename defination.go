...
func NeatAutoGenerated(a *AutoGenerated) (n *neatAutoGenerated) {
	n = &neatAutoGenerated{
		ID:       a.ID,
		Phonetic: a.Results[0].LexicalEntries[0].Entries[0].Pronunciations[0].PhoneticSpelling,
		Audio:    a.Results[0].LexicalEntries[0].Entries[0].Pronunciations[0].AudioFile,
	}
